...
function btn1() {
    ...
    document.getElementById("step1_txt").innerText = '콜라가 죽었다. 500원';
}
function btn2() {
    음료 = '사이다'
    금액 = 450
    document.getElementById("step1_txt").classList.remove("dis-none")
    document.getElementById("step1_txt").innerText = '사이다는 돌아오지않았다. 450원';
}
function btn3() {
    음료 = '환타'
    금액 = 300
    document.getElementById("step1_txt").classList.remove("dis-none")
    document.getElementById("step1_txt").innerText = '환타는 빛을 잃었다. 300원';
}
